...
`openapi.json` is the zm-api contract the dashboard is built and tested
...
```sh
curl -s http://<zm-api-host>/api-docs/openapi.json -o src/test/openapi/openapi.json
npm test          # contract + fixture tests tell you what drifted
```

Captured 2026-08-22 from the dev box (zm-api 3.0.0-alpha.1, 152 paths,
ZoneMinder 1.39.16).
