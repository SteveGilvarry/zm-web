/**
 * Integration tests for the reports.detail page (P26).
 *
 * The page pulls in TanStack Router's <Link>; we stub the router exports
 * the same way the Groups page tests do, and serve `getReport` /
...
async function mount() {
  ...
  return renderWithProviders(<Page reportId={REPORT_ID} />);
}
