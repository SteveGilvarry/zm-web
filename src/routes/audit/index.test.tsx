/**
 * Integration-style tests for the /audit route.
 *
 * Same harness pattern as /groups: mock the file-based router exports,
 * stub `<AppShell>` so we render just the page body, and back the data
...
beforeAll(() => {
  ...
  // Pin to modern skin by default; one test below overrides to classic.
...
/** Make a minimal Monitor shaped record (cast through unknown — the route
...
describe('AuditPage — classic skin', () => {
  it('renders the classic table layout when ui.skin === "classic"', async () => {
