/**
 * Integration-style tests for the Groups route.
 *
 * The route component is wrapped in <AppShell> (which expects router
 * context) and pulls in TanStack Router. We stub both so we can render
 * just the page body and exercise the tree + dialog + delete flows
 * against MSW-faked endpoints.
 */
...
/** Mount the route's exported component. */
...
describe('GroupsPage — tree rendering', () => {
  it('renders groups with depth-based indentation', async () => {
    ...
    // Depth annotations on each li come from the route component.
