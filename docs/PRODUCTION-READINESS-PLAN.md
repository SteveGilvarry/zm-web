...
**Still open from the audits, frontend-possible** (in the audits' own numbering): console 3, 5, 6 (partly backend), 8, 10, 12, 13; watch 6, 12, 16; events-and-filters 3, 12, 15, 20; event-view 7, 8 (partly backend), 10, 12, 13, 14, F1, F3, F5, S1; montage 2 (gridstack edit), 9, 10, 11, 13, 15, 17, 18, 19; options 3, 4 (partly backend), 7 (partly backend), 9, 10, 12, 13. **Backend-blocked:** watch 1, 2, 4, 5, 7, 8, 13; events 4, 5, 6, 7, 8, 9, 11, 18, 19; event-view 11, 15, F2, F4; montage 5, 12; options 2, 5, 6b, 6c, 8, 14 — each already has, or needs, a zm-api ticket (Section 7).
